    ...
    Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
        ...
        Route::group(['prefix' => 'vendor-settings', 'as' => 'vendor-settings.', 'middleware' => ['module:system_settings']], function () {
            Route::controller(VendorSettingsController::class)->group(function () {
                Route::get(BusinessSettings::VENDOR_VIEW[URI], 'index')->name('index');
        ...
        Route::group(['prefix' => 'offline-payment-method', 'as' => 'offline-payment-method.', 'middleware' => ['module:system_settings']], function () {
            Route::controller(OfflinePaymentMethodController::class)->group(function () {
                Route::get(OfflinePaymentMethod::INDEX[URI], 'index')->name('index');
                Route::get(OfflinePaymentMethod::ADD[URI], 'getAddView')->name('add');
                Route::post(OfflinePaymentMethod::ADD[URI], 'add');
                Route::get(OfflinePaymentMethod::UPDATE[URI] . '/{id}', 'getUpdateView')->name('update');
                Route::post(OfflinePaymentMethod::UPDATE[URI] . '/{id}', 'update');
                Route::post(OfflinePaymentMethod::DELETE[URI], 'delete')->name('delete');
                Route::post(OfflinePaymentMethod::UPDATE_STATUS[URI], 'updateStatus')->name('update-status');
            });
        });
