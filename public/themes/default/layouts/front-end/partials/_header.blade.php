        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu">
            <div class="container px-10px">
                <div class="collapse navbar-collapse text-align-direction" id="navbarCollapse">
                    ...
                    @php($categories =
                    \App\Utils\CategoryManager::getCategoriesWithCountingAndPriorityWiseSorting(dataLimit: 11))
                    ...
                    <ul class="navbar-nav mega-nav1 pr-md-2 pl-md-2 d-block d-xl-none">
                        <li class="nav-item dropdown d-md-none">
                            ...
                            <ul class="dropdown-menu __dropdown-menu-2 text-align-direction">
                                ...
                                @php($categoryIndex++)
                                @if($categoryIndex < 10) <li class="dropdown">
                    ...
                    $web_config['discount_product'] > 0 || $web_config['clearance_sale_product_count'] > 0))
                    <li class="nav-item dropdown">
                    ...
                    @elseif(
                    ($web_config['flash_deals'] && count($web_config['flash_deals_products']) > 0) &&
                    !(count($web_config['featured_deals']) > 0 || $web_config['discount_product'] > 0 ||
                    ...
                    !(count($web_config['featured_deals']) > 0 || ($web_config['flash_deals'] &&
                    count($web_config['flash_deals_products']) > 0) || $web_config['clearance_sale_product_count'] > 0)
                    )
                    <li class="nav-item dropdown">
                        <a class="nav-link text-capitalize"
                    ...
                    ($web_config['clearance_sale_product_count'] > 0) &&
                    !(count($web_config['featured_deals']) > 0 || ($web_config['flash_deals'] ||
                    count($web_config['flash_deals_products']) > 0) || $web_config['discount_product'] > 0)
                    )
                    <li class="nav-item dropdown">
                        <a class="nav-link text-capitalize"
                    ...
                    @elseif(count($web_config['featured_deals']) > 0 || ($web_config['flash_deals'] &&
                    count($web_config['flash_deals_products']) > 0) || $web_config['discount_product'] > 0 ||
                    $web_config['clearance_sale_product_count'] > 0)
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            @if($publishingHousesIndex < 10 && $publishingHouseItem['name'] !='Unknown' )
                                ...
                                <div class="align-baseline">
                                    ...
                                    <span class="count-value px-2">(
                                        {{ $publishingHouseItem['publishing_house_products_count'] }} )</span>
                                    @endif
                                </div>
                    </li>
                    @endif
